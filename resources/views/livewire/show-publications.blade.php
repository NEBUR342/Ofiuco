<div class='min-[480px]:px-12 mt-4 cursor-default'>
    <div class="h-16"></div>
    @if (auth()->guest() || (auth()->check() && auth()->user()->email_verified_at))
        <div class="flex mb-3">
            <div class="flex-1">
    ...
    <div class="text-center">
        <span>PARA PODER CONTINUAR CON ESTA CUENTA DEBES VERIFICAR EL CORREO, NO OLVIDES QUE SE PUEDE ENCONTRAR EN SPAM</span>
    <p>SI NECESITAS AYUDA CONTACTANOS DESDE NUESTRo APARTADO DE <a href="{{route('contactanos.pintar')}}" class="text-blue-500 hover:text-blue-700">CONTACTANOS</a></p>
    </div>
    @endif
</div>
