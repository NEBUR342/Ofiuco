        ...
        <div class="flex flex-col min-[700px]:px-6 min-[700px]:w-1/2 max-[700px]:mx-5 mx-auto">
            ...
            <div class="flex flex-wrap text-xl">
                <a title="COMPARTIR COMUNIDAD"
                    href="https://api.whatsapp.com/send?text=http://127.0.0.1:8000/community/{{ $comunidad->id }}"
                ...
                <a title="COMPARTIR COMUNIDAD"
                    href="http://www.facebook.com/sharer.php?u=http://127.0.0.1:8000/community/{{ $comunidad->id }}&t=Mira la comunidad {{$comunidad->nombre}} en Ofiuco"
                ...
                <a title="COMPARTIR COMUNIDAD"
                    href="https://twitter.com/intent/tweet?text=Mira la comunidad {{$comunidad->nombre}} de Ofiuco en:&url=http://127.0.0.1:8000/community/{{ $comunidad->id }}"
                    target="_blank" class="cursor-pointer mx-auto my-5">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50"
                        height="50" viewBox="0 0 48 48">
                        <path fill="#03A9F4"
                ...
                <a title="COMPARTIR COMUNIDAD"
                    href="https://www.reddit.com/submit?url=http://127.0.0.1:8000/community/{{ $comunidad->id }}"
                    target="_blank" class="cursor-pointer mx-auto my-5">
