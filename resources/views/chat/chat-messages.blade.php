...
@section('contenido')
    <div class="flex ">
        <input type="checkbox" id="drawer-toggle" class="relative sr-only peer hidden" checked>
        ...
        <div @class([
            ...
            <div class="h-16"></div>
            <div class="px-6 py-4 justify-center" id="contactos"></div>
        </div>
    </div>
    <div class="h-screen flex flex-col">
        <div class="flex-grow">
            ...
            <div class="flex flex-wrap justify-center sm:justify-end">
                <div id="mensajes" class="sm:w-5/6 sm:mr-6"></div>
            </div>
        </div>
        @if($tipo!=0 && $tipoid!=0)
