<x-guest-layout>
    <div class='px-3 min-[480px]:px-12 mt-4 cursor-default'>
        <div class="h-16"></div>
        <div class="min-[800px]:flex min-[800px]:flex-wrap min-[800px]:justify-around">
            ...
            <div class="sm:w-2/3 min-[800px]:w-1/2 min-[1100px]:w-1/3">
                <div class="w-96 mx-auto">
                    ...
                    <ul class="text-base min-[400px]:text-xl">
                        ...
                        <li>
                            <a href="#seccion24" class="min-[400px]:ml-6 text-blue-500 hover:text-blue-700">
                                VER PUBLICACIÓN
                            </a>
                        </li>
                        <li>
                            <a href="#seccion25" class="min-[400px]:ml-6 text-blue-500 hover:text-blue-700">
                                VER COMUNIDAD
                            </a>
                        </li>
                        <li>
                            <a href="#seccion26" class="min-[400px]:ml-6 text-blue-500 hover:text-blue-700">
        ...
        <div @class([
            ...
            <div class="pb-2 text-left mx-3">
                ...
                <p>
                    Debajo de las publicaciones encontrarás las comunidades que has creado y las comunidades en las que
                    participas.
                </p>
            </div>
        </div>
        ...
        <div @class([
            ...
            <div class="pb-2 text-left mx-3">
                ...
                <p>
                    A la derecha tienes acciones que puedes hacer con los usuarios, como puede ser el de mandar o rechazar
                    solicitudes de amistad o eliminar una amistad que ya tienes.
                </p>
            </div>
        </div>
        ...
        <div @class([
            ...
            <div class="pb-2 text-left mx-3">
                ...
                <div class='border-solid border-2 border-indigo-600 rounded-lg' style="overflow: hidden;">
                    <div class="relative">
                        <div class="flex ">
                            <input type="checkbox" id="drawer-toggle" class="relative sr-only peer" checked>
                            <label for="drawer-toggle"
                                class="cursor-pointer absolute top-0 left-0 inline-block p-4 transition-all duration-500 bg-indigo-500 rounded-lg peer-checked:rotate-180 peer-checked:left-64">
                                <div class="w-6 h-1 mb-3 -rotate-45 bg-white rounded-lg"></div>
                                <div class="w-6 h-1 rotate-45 bg-white rounded-lg"></div>
                            </label>
                            <div @class([
                                'top-0 left-0 w-64 h-full transition-all duration-500 transform -translate-x-full shadow-lg peer-checked:translate-x-0',
                                    ...
                                    <div class="px-6 py-4 justify-center">
                                        <ul role="list" class="max-w-sm divide-y divide-gray-200">
                                            <li class="py-3 sm:py-4">
                                                <h4 class='text-lg font-semibold text-center mb-5'>CONTACTOS</h4>
                                                <a href="#" title='nombre usuario'
                                                    ...
                                                    <div class='min-w-0'>
                                                        ...
                                                        <p class='text-sm truncate'>Ultimo mensaje</p>
                                                    </div>
                                                    <div
                                            ...
                                            <li class="py-3 sm:py-4">
                                                <h4 class='text-lg font-semibold text-center mb-5'>MIS COMUNIDADES</h4>
                                            ...
                                            <li class="py-3 sm:py-4">
                                                <h4 class='text-lg font-semibold text-center mb-5'>COMUNIDADES</h4>
                                                <a href="#" title='nombre comunidad'
                                                    class='flex items-center space-x-3 relative mb-5'>
                                                    <div class='flex-shrink-0'>
                                                        <img class='w-8 h-8 rounded-full' src="imagen" alt='foto'>
                ...
                <p class="my-3">Los mensajes de esta vista se mostrarán de la siguiente manera:</p>
        ...
        <div @class([
            ...
            <div class="pb-2 text-left mx-3">
                ...
                <p>
                    ...
                    foto
                    de perfil, el nombre, la contraseña...
                </p>
            </div>
        </div>
        ...
        <div @class([
            ...
            <div class="pb-2 text-left mx-3">
                <p>
                    Para poder cambiar entre el modo claro y el modo oscuro debes pincha en el icono que aparezca, debe ser
                    uno de estos dos, los cuales representan si tienes el modo claro o el modo oscuro.
                </p>
                <p>
        ...
        <div @class([
            ...
            <div class="pb-2 text-left mx-3">
                ...
                <p>
                    Lo que hace es mandar un correo al usuario registrado, este se puede encontrar en spam, al verificar en
                    el correo que es el usuario registrado entonces el usuario tiene acceso a todas las opciones que ofrece
                    la página.
                </p>
        ...
        <div id="seccion24" class="h-24"></div>
        <div @class([
            'rounded-lg text-center',
            'bg-gray-700' => auth()->check() && auth()->user()->temaoscuro,
            'bg-gray-200' => auth()->guest() || !auth()->user()->temaoscuro,
        ])>
            <p class="text-2xl py-3">VER PUBLICACIÓN</p>
            <div class="pb-2 text-left mx-3">
                <p>
                ...
                <p>
                    También puedes realizar una serie de acciones, como puede ser la de darle like y save, en caso de ser el
                    creador de la publicación puedes editarlo y borrarlo.
                </p>
                <p>
                    Debajo de esto se aprecian unos iconos de redes sociales, esto es por si apetece al usuario compartir
                    esta publicación con otros usuarios en esas redes sociales.
                </p>
                <p>
                    Por último lo que podemos ver es un apartado de comentarios, donde los usuarios de la página pueden
                    escribir y opinar a cerca de la publicación de los usuarios.
                </p>
            </div>
        </div>
        <div id="seccion25" class="h-24"></div>
        <div @class([
            'rounded-lg text-center',
            'bg-gray-800' => auth()->check() && auth()->user()->temaoscuro,
            'bg-gray-300' => auth()->guest() || !auth()->user()->temaoscuro,
        ])>
            <p class="text-2xl py-3">VER COMUNIDAD</p>
            <div class="pb-2 text-left mx-3">
                <p>
                ...
                <p>
                    Tienes una serie de opciones, como la de participar en la comunidad, en caso de pertenecer a esta
                    puedes salirte, ver las publicaciones de la comunidad y en caso de ser el dueño de la comunidad (el
                    administrador también) puedes editar y borrar la comunidad.
                </p>
                <p>
                    Debajo de esto se aprecian unos iconos de redes sociales, esto es por si apetece al usuario compartir
                    esta comunidad con otros usuarios en esas redes sociales.
                </p>
                <p>
                    Por último si eres el creador de la comunidad (el administrador también) puedes ver a los participantes
                    de esta y puedes expulsarlos.
                </p>
            </div>
        </div>
        <div id="seccion26" class="h-24"></div>
        <div @class([
            'rounded-lg text-center',
            'bg-gray-700' => auth()->check() && auth()->user()->temaoscuro,
            'bg-gray-200' => auth()->guest() || !auth()->user()->temaoscuro,
        ])>
            <p class="text-2xl py-3">PERFIL DE OTROS USUARIOS</p>
            <div class="pb-2 text-left mx-3">
                <p>
                    Se mostrará una vista similar a la de
                    <a class="text-blue-500 hover:text-blue-700" href="#seccion04">
                        PERFIL DE USUARIO,
                    </a>
                ...
                <p>
                    Debajo de las publicaciones encontrarás las comunidades que ha creado y las comunidades en las que
                    participa.
                </p>
            </div>
        </div>
    ...
    <script>
        ...
        function cambiarModoOscuro() {
            ...
            if (usuarioLogueado) {
                if (modoOscuro) {
                    nuevo.innerHTML =
                        "<div class='bg-gray-600 border-solid border-2 border-indigo-600 rounded-lg'><div class='flex flex-wrap justify-center mt-1'><button onclick='cambiarLoginUsuario()' class='mr-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Usuario registrado</button><button onclick='cambiarModoOscuro()' class='ml-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full max-[422px]:mt-1'>Modo oscuro</button></div><div class='mb-3 flex flex-row-reverse'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mt-2 mx-2 rounded-tl-xl bg-gray-700 text-white'>Usuario normal</p></div><div class = 'mb-3 flex flex-row-reverse'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mx-2 rounded-tl-xl bg-blue-700 text-white'>Dueño de la comunidad</p></div><div class = 'mb-3 flex flex-row-reverse'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl font-bold text-white mx-2 rounded-tl-xl bg-gradient-to-r from-red-600 from-10% via-indigo-600 via-80% to-blue-600 to-90%'>Administrador</p></div></div>";
                } else {
                    nuevo.innerHTML =
                        "<div class='bg-gray-100 border-solid border-2 border-indigo-600 rounded-lg'><div class='flex flex-wrap justify-center mt-1'><button onclick='cambiarLoginUsuario()' class='mr-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Usuario registrado</button><button onclick='cambiarModoOscuro()' class='ml-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full max-[422px]:mt-1'>Modo claro</button></div><div class = 'mb-3 flex flex-row-reverse'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mt-2 mx-2 rounded-tl-xl bg-gray-300'>Usuario normal</p></div><div class = 'mb-3 flex flex-row-reverse'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mx-2 rounded-tl-xl bg-blue-400'>Dueño dela comunidad</p></div><div class = 'mb-3 flex flex-row-reverse'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl font-bold text-white mx-2 rounded-tl-xl bg-gradient-to-r from-red-500 from-10% via-indigo-500 via-80% to-blue-500 to-90%'>Administrador</p></div></div>";
                }
            } else {
                if (modoOscuro) {
                    nuevo.innerHTML =
                        "<div class='bg-gray-600 border-solid border-2 border-indigo-600 rounded-lg'><div class='flex flex-wrap justify-center mt-1'><button onclick='cambiarLoginUsuario()' class='mr-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Otro usuario</button><button onclick='cambiarModoOscuro()' class='ml-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full max-[422px]:mt-1'>Modo oscuro</button></div><div class = 'mb-3 flex'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mt-2 mx-2 rounded-tr-xl bg-gray-700 text-white'>Usuario normal</p></div><div class = 'mb-3 flex'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mx-2 rounded-tr-xl bg-blue-700 text-white'>Dueño de la comunidad</p></div><div class = 'mb-3 flex'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl font-bold text-white mx-2 rounded-tr-xl bg-gradient-to-r from-red-600 from-10% via-indigo-600 via-80% to-blue-600 to-90%'>Administrador</p></div></div>";
                } else {
                    nuevo.innerHTML =
                        "<div class='bg-gray-100 border-solid border-2 border-indigo-600 rounded-lg'><div class='flex flex-wrap justify-center mt-1'><button onclick='cambiarLoginUsuario()' class='mr-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Otro usuario</button><button onclick='cambiarModoOscuro()' class='ml-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full max-[422px]:mt-1'>Modo claro</button></div><div class = 'mb-3 flex'><p class='max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mt-2 mx-2 rounded-tr-xl bg-gray-300'>Usuario normal</p></div><div class = 'mb-3 flex'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl mx-2 rounded-tr-xl bg-blue-400'>Dueño de la comunidad</p></div><div class = 'mb-3 flex'><p class = 'max-w-[80%] xl:max-w-2xl py-1 px-4 rounded-br-xl rounded-bl-xl font-bold text-white mx-2 rounded-tr-xl bg-gradient-to-r from-red-500 from-10% via-indigo-500 via-80% to-blue-500 to-90%'>Administrador</p></div></div>";
                }
            }
        }
